...
c.content.site_specific_quirks.skip = ['js-string-replaceall', 'ua-whatsapp']
...
## Type: String
c.downloads.open_dispatcher = "aria2"
...
## Type: ShellCommand
c.editor.command = ['alacritty', '-e', 'vim', "+call cursor({line}, {column})", "--", "{file}"]
...
## Type: Padding
c.tabs.indicator.padding = {'top': 1, 'bottom': 1, 'left': 1, 'right': 4}
